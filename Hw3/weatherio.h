 ...
 */
int validate_format(const char *filename);
 ...
 */
int header_columns(const char *filename);
 ...
 * no longer needs it.
 */
int read_header(const char *filename, char **columns);
 ...
 */
int read_row(FILE *file, const char **columns, void **data);
